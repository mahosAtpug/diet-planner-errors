                ...
                <Text style={{color:"white" , marginLeft:100}}>
                       ...
                       <Text style={styles.text}>
                        ...
                        {"\n"}
                              ...
                              2. Keep it in the fridge to set. Meanwhile, add BANANA , PEANUT BUTTER , JAGGER POWDER and SALT to blender jar.
                             
                              {"\n"}
                               3. Process untill you get a smooth creamy texture
                               {"\n"}
                               4. Remove the mold from the fridge. Fill the cups with PEANUT BUTTER mixture leaving enough room to add a layer of chocolate on top. Flatten out the mixture with a spoon and put it back in the firdge for 10 mins.
                               {"\n"}
